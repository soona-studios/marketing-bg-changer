...
async function requestBackgroundChange (base64File, backgroundColor) {
  ...
  const resp = await AwsWafIntegration.fetch('https://cv-pub.ml.soona.dev/v2/sync/media-editor/background/replace',
            {
                method: 'POST',
                headers: {
...
async function requestMaskedImage (base64File) {
  ...
  const resp = await AwsWafIntegration.fetch('https://cv-pub.ml.soona.dev/v2/sync/media-editor/background/remove',
            {
                method: 'POST',
                headers: {
                    "Content-Type": "application/json",
